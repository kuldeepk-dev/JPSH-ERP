                        ...
                        <div class="admission-card">
                            ...
                            <div class="row">
                                <div class="col-lg-6 mt-3">
                                    ...
                                    <select class="primary_select form-control" name="session" id="academic_year" required>
                                        ...
                                        @foreach ($sessions as $session)
                                            <option value="{{ $session->id }}" {{ old('session', getAcademicId()) == $session->id ? 'selected' : '' }}>
                                ...
                                <div class="col-lg-6 mt-3">
                                    ...
                                    <input class="primary_input_field form-control" name="roll_number" value="{{ old('roll_number') }}">
                                </div>
                                <div class="col-lg-6 mt-3">
                                ...
                                <div class="col-lg-6 mt-3">
                                    ...
                                    <input class="primary_input_field form-control" name="first_name" value="{{ old('first_name') }}" required>
                                </div>
                                <div class="col-lg-6 mt-3">
                                    <label class="primary_input_label">Student Last Name<span class="required-star">*</span></label>
                                    <input class="primary_input_field form-control" name="last_name" value="{{ old('last_name') }}" required>
                                </div>
                                <div class="col-lg-6 mt-3">
                                    <label class="primary_input_label">Email</label>
                                    <input class="primary_input_field form-control" name="email_address" value="{{ old('email_address') }}">
                                </div>
                                <div class="col-lg-6 mt-3">
                                ...
                                <div class="col-lg-6 mt-3">
                                    ...
                                    <select class="primary_select form-control" name="religion">
                                        ...
                                        @foreach ($religions as $religion)
                                            <option value="{{ $religion->id }}">{{ $religion->base_setup_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-lg-6 mt-3">
                                ...
                                <div class="col-lg-6 mt-3">
                                    ...
                                    <select class="primary_select form-control" name="blood_group">
                                        ...
                                        @foreach ($blood_groups as $blood)
                                            <option value="{{ $blood->id }}">{{ $blood->base_setup_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-lg-6 mt-3">
...
@push('script')
    <script>
        (function() {
            ...
            var globalHeaderBoard = @json(selectedBoard());
