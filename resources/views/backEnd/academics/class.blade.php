                                    ...
                                    <div class="row mt-25">
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                ...
                                                <select class="primary_select form-control{{ @$errors->has('board_name') ? ' is-invalid' : '' }}" name="board_name" id="board_name">
                                                    <option data-display="Select Boards" value="">Select Boards</option>
                                                    @foreach (generalBoards() as $board)
                                                        <option value="{{ $board }}" {{ (isset($classById) && @$classById->board_name == $board) || (!isset($classById) && selectedBoard() === $board) ? 'selected' : '' }}>
                                                            {{ $board }}
                                                        </option>
                                                    @endforeach
                                                </select>
