...
<style>
    ...
    button#mobileSelectorDropdown + .dropdown-menu .boardChange,
    ...
    button#mobileSelectorDropdown + .dropdown-menu .boardChange:hover,
        ...
        <div class="col-lg-12 p-0">
            <div class="header_iner d-flex justify-content-between align-items-center">
                ...
                <div class="header_right d-flex justify-content-between align-items-center">
                    ...
                    ?>
                    <?php if(!empty($boards)): ?>
                        <select name="#" class="nice_Select bgLess mb-0 boardChange" id="boardChange">
                            ...
                            <?php $__currentLoopData = $boards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $board): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($board); ?>" <?php echo e(selectedBoard() === $board ? 'selected' : ''); ?>>
                                    <?php echo e($board); ?>
                    ...
                    <div class="dropdown d-sm-none">
                        ...
                        <?php if(!empty($boards)): ?>
                            <select name="#" class="nice_Select bgLess mb-0 boardChange" id="boardChange_mbl">
                                <option value="">All Boards</option>
                                <?php $__currentLoopData = $boards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $board): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($board); ?>" <?php echo e(selectedBoard() === $board ? 'selected' : ''); ?>>
                                        <?php echo e($board); ?>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#boardChange_mbl').on('change', function () {
...
<?php /**PATH C:\xampp\htdocs\infixEdu_v9.0.1\resources\views/backEnd/partials/menu.blade.php ENDPATH**/ ?>