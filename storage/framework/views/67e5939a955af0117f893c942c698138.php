    ...
    <section class="admin-visitor-area up_admin_visitor">
        <div class="container-fluid p-0">
            ...
            <div class="row">
                ...
                <?php if(userPermission('postal-receive-store') || isset($postal_receive)): ?>
                <div class="col-lg-4 col-xl-3">
                    <div class="row">
                        <div class="col-lg-12">
                            <?php if(isset($postal_receive)): ?>
                                <?php echo e(html()->form('PUT', url('postal-receive/' . @$postal_receive->id))->attribute('class', 'form-horizontal')->attribute('enctype', 'multipart/form-data')->attribute('files', true)->open()); ?>

                            <?php else: ?>
                                <?php if(userPermission('postal-receive-store')): ?>
                                    <?php echo e(html()->form('POST', route('postal-receive-store'))->attribute('class', 'form-horizontal')->attribute('enctype', 'multipart/form-data')->attribute('files', true)->open()); ?>
                                    ...
                                    <div class="row mt-15">
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                ...
                                                <?php if(isset($postal_receive)): ?>
                                                    <textarea class="primary_input_field form-control" cols="0" rows="4" name="note"> <?php echo e(@$postal_receive->note); ?></textarea>
                                                <?php else: ?>
                                                    <textarea class="primary_input_field form-control" cols="0" rows="4" name="note"><?php echo e(old('note')); ?></textarea>
                                                    <?php endif; ?>
                ...
                <?php endif; ?>
                <div class="<?php if(userPermission('postal-receive-store') || isset($postal_receive)): ?> col-lg-8 col-xl-9 <?php else: ?> col-lg-12 <?php endif; ?>">
                    <div class="white-box">
                        <div class="row">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mt-40 d-flex justify-content-between">
                            ...
                            <?php echo e(html()->form('POST', route('postal-receive_delete'))->attribute('enctype', 'multipart/form-data')->open()); ?>
...
<?php echo $__env->make('backEnd.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\infixEdu_v9.0.1\resources\views/backEnd/admin/postal_receive.blade.php ENDPATH**/ ?>