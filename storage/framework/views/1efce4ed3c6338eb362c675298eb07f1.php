                        ...
                        <div class="row mb-30">
                            ...
                            <div class="col-lg-4">
                                <div class="primary_input">
                                    ...
                                    <small class="text-muted d-block"><?php echo e(implode(', ', generalBoards())); ?></small>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-30">
...
<?php echo $__env->make('backEnd.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\infixEdu_v9.0.1\resources\views/backEnd/systemSettings/updateGeneralSettings.blade.php ENDPATH**/ ?>