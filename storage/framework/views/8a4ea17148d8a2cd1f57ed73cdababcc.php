                            ...
                            <div class="row mb-40 mt-30">
                                ...
                                <?php else: ?>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="primary_input ">
                                            <select
                                                class="primary_select form-control<?php echo e($errors->has('board_id') ? ' is-invalid' : ''); ?>"
                                                name="board_id" id="import_board_id">
                                                <option data-display="<?php echo app('translator')->get('common.select_board'); ?>" value="">
                                                    <?php echo app('translator')->get('common.select_board'); ?></option>
        ...
        (function($) {
            ...
            function resetClassDropdown() {
                $('#classSelectStudent')
                    ...
                    .append($('<option>', {
                        value: '',
                        text: "<?php echo e(__('student.select_class')); ?>"
                    }))
                    .prop('disabled', true);
            ...
            function resetSectionDropdown() {
                $('#sectionSelectStudent')
                    ...
                    .append($('<option>', {
                        value: '',
                        text: "<?php echo e(__('student.select_section')); ?>"
                    }))
                    .prop('disabled', true);
...
<?php echo $__env->make('backEnd.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\infixEdu_v9.0.1\resources\views/backEnd/studentInformation/import_student.blade.php ENDPATH**/ ?>