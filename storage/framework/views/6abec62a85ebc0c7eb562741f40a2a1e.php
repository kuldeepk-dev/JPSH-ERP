<?php $__env->startSection('title'); ?>
    <?php echo e($page_title ?? __('student.student_admission')); ?>
...
<?php $__env->startSection('mainContent'); ?>
    <section class="sms-breadcrumb mb-20 up_breadcrumb">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <h1><?php echo e($page_title ?? __('student.student_admission')); ?></h1>
                <div class="bc-pages">
                    <a href="<?php echo e(route('dashboard')); ?>"><?php echo app('translator')->get('common.dashboard'); ?></a>
                    <a href="#"><?php echo app('translator')->get('student.student_information'); ?></a>
                    <a href="#"><?php echo e($page_title ?? __('student.student_admission')); ?></a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="admin-visitor-area up_st_admin_visitor">
        <div class="container-fluid p-0">
            <?php echo e(html()->form('POST', $form_action ?? route('student_store'))->attributes([
            ...
            <input type="hidden" name="id" value="<?php echo e($edit_student_id); ?>">
            <input type="hidden" name="student_id" value="<?php echo e($edit_student_id); ?>">
            <input type="hidden" name="form_mode" id="form_mode" value="<?php echo e($form_mode ?? 'create'); ?>">
            <input type="hidden" name="url" id="url" value="<?php echo e(URL::to('/')); ?>">

            <div class="admission-wizard">
                <div class="admission-stepper">
                    <h4><?php echo e($page_title ?? 'Admission Progress'); ?></h4>
                ...
                <div>
                    <div class="admission-step active" data-step="1">
                        <div class="admission-card">
                            <h4><?php echo e($card_title ?? 'Student Information'); ?></h4>
                            <div class="row">
                                ...
                                <div class="col-lg-6 mt-3">
                                    ...
                                    <select class="primary_select form-control" id="admission_board_id" name="board_id" required>
                                        ...
                                        <?php $__currentLoopData = generalBoards(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $board): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($board); ?>" <?php echo e(old('board_id') === $board ? 'selected' : ''); ?>>
                                                <?php echo e($board); ?>
                                ...
                                <div class="col-lg-6 mt-3">
                                    ...
                                    <input class="primary_input_field form-control" name="admission_number" value="<?php echo e(old('admission_number')); ?>" required>
                                </div>
                                <div class="col-lg-6 mt-3">
                                ...
                                <div class="col-lg-6 mt-3">
                                    ...
                                    <input class="primary_input_field form-control" type="date" name="admission_date" value="<?php echo e(old('admission_date', now()->format('Y-m-d'))); ?>" required>
                                </div>
                                <div class="col-lg-6 mt-3">
                        ...
                        <div class="admission-card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 mt-3">
                                    ...
                                    <input class="form-control" type="file" name="document_file_1" accept=".pdf,.jpg,.jpeg,.png" <?php echo e(($form_mode ?? 'create') === 'create' ? 'required' : ''); ?>>
                                    <input class="form-control" type="file" name="document_birth_certificate" accept=".pdf,.jpg,.jpeg,.png" <?php echo e(($form_mode ?? 'create') === 'create' ? 'required' : ''); ?>>
                                    <?php if(!empty($edit_student_data['existing_documents']['document_file_1'])): ?>
                                        <small class="d-block mt-2">Existing: <a href="<?php echo e(asset($edit_student_data['existing_documents']['document_file_1'])); ?>" target="_blank"><?php echo e(basename($edit_student_data['existing_documents']['document_file_1'])); ?></a></small>
                                    <?php endif; ?>
                                </div>
                                <div class="col-lg-6 mt-3">
                                ...
                                <div class="col-lg-6 mt-3">
                                    ...
                                    <input class="form-control" type="file" name="document_file_2" accept=".pdf,.jpg,.jpeg,.png" <?php echo e(($form_mode ?? 'create') === 'create' ? 'required' : ''); ?>>
                                    <input class="form-control" type="file" name="document_transfer_certificate" accept=".pdf,.jpg,.jpeg,.png" <?php echo e(($form_mode ?? 'create') === 'create' ? 'required' : ''); ?>>
                                    <?php if(!empty($edit_student_data['existing_documents']['document_file_2'])): ?>
                                        <small class="d-block mt-2">Existing: <a href="<?php echo e(asset($edit_student_data['existing_documents']['document_file_2'])); ?>" target="_blank"><?php echo e(basename($edit_student_data['existing_documents']['document_file_2'])); ?></a></small>
                                    <?php endif; ?>
                                </div>
                                <div class="col-lg-6 mt-3">
                                    <label class="primary_input_label">Passport Photos<span class="required-star">*</span></label>
                                    <input class="form-control" type="file" name="document_passport_photos" accept=".jpg,.jpeg,.png" multiple <?php echo e(($form_mode ?? 'create') === 'create' ? 'required' : ''); ?>>
                                </div>
                                <div class="col-lg-6 mt-3">
                                ...
                                <div class="col-lg-6 mt-3">
                                    ...
                                    <input class="form-control" type="file" name="document_file_3" accept=".pdf,.jpg,.jpeg,.png" <?php echo e(($form_mode ?? 'create') === 'create' ? 'required' : ''); ?>>
                                    <input class="form-control" type="file" name="document_report_card" accept=".pdf,.jpg,.jpeg,.png" <?php echo e(($form_mode ?? 'create') === 'create' ? 'required' : ''); ?>>
                                    <?php if(!empty($edit_student_data['existing_documents']['document_file_3'])): ?>
                                        <small class="d-block mt-2">Existing: <a href="<?php echo e(asset($edit_student_data['existing_documents']['document_file_3'])); ?>" target="_blank"><?php echo e(basename($edit_student_data['existing_documents']['document_file_3'])); ?></a></small>
                                    <?php endif; ?>
                                </div>
                                <div class="col-lg-6 mt-3">
                                ...
                                <div class="col-lg-6 mt-3">
                                    ...
                                    <?php if(!empty($edit_student_data['existing_documents']['document_file_4'])): ?>
                                        <small class="d-block mt-2">Existing: <a href="<?php echo e(asset($edit_student_data['existing_documents']['document_file_4'])); ?>" target="_blank"><?php echo e(basename($edit_student_data['existing_documents']['document_file_4'])); ?></a></small>
                                    <?php endif; ?>
                                </div>
                                <div class="col-lg-6 mt-3">
                                    <label class="primary_input_label">Aadhaar Copies<span class="required-star">*</span></label>
                                    <input class="form-control" type="file" name="document_aadhaar" accept=".pdf,.jpg,.jpeg,.png" <?php echo e(($form_mode ?? 'create') === 'create' ? 'required' : ''); ?>>
                                </div>
                            </div>
...
Parent/Guardian declaration, fee acknowledgement, discipline and policy agreement, and consent to school rules apply as per school admission policy.
                    ...
                    <div class="admission-actions">
                        ...
                        <div class="d-flex" style="gap: 10px;">
                            ...
                            <button type="submit" class="primary-btn fix-gr-bg" id="submit_admission" style="display:none;"><?php echo e($submit_button_text ?? 'Submit Application'); ?></button>
                        </div>
                    </div>
                </div>
            </div>
...
<?php $__env->startPush('script'); ?>
    <script>
        (function() {
            ...
            var currentStep = 1;
            var totalSteps = 9;
            var formMode = <?php echo json_encode($form_mode ?? 'create', 15, 512) ?>;
            var editStudentData = <?php echo json_encode($edit_student_data ?? null, 15, 512) ?>;
    ...
    <?php if(!empty($draft_application) && false): ?>
        <script>
            (function() {
