...
<?php
    ...
    $edulia_theme = ['home-slider','pagebuilder','expert-teacher','photo-gallery','video-gallery','front-result','front-class-routine','front-exam-routine','front-academic-calendar'];
...
<li class="<?php echo e(spn_active_link($routes, "mm-active")); ?> <?php echo e($menu->route); ?>">
    ...
    <ul class="mm-collapse">  
        <?php $__currentLoopData = $child->childs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $third): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                  
            <?php if(userPermission($third->route) && isMenuAllowToShow($third->route)): ?>
                <?php 
...
</li><?php /**PATH C:\xampp\htdocs\infixEdu_v9.0.1\resources\views/backEnd/menu/staff_sub_menu.blade.php ENDPATH**/ ?>