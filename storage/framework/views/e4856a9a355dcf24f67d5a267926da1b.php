            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box">
                        ...
                        <?php if(isset($v_custom_field) && userPermission('edit-custom-field')): ?>
                          
                            <?php echo e(html()->form('POST', route('update-student-registration-custom-field'))->class('form-horizontal')->open()); ?>

                                <input type="hidden" name="id" value="<?php echo e($v_custom_field->id); ?>">
                          
                        <?php else: ?>
                            <?php if(userPermission('store-student-registration-custom-field')): ?>
                                <?php echo e(html()->form('POST', route('store-student-registration-custom-field'))->class('form-horizontal')->open()); ?>

                            <?php endif; ?>
                        <?php endif; ?>
                            <?php echo $__env->make('backEnd.customField._custom_form', ['type' => 'student_online_regi'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <?php if(userPermission('store-student-registration-custom-field') || userPermission('edit-custom-field')): ?>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mt-40 d-flex justify-content-between">
                                                                    ...
                                                                    <?php echo e(html()->form('POST', route('delete-custom-field'))->open()); ?>
...
<?php echo $__env->make('backEnd.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\infixEdu_v9.0.1\resources\views/backEnd/customField/studentRegistration.blade.php ENDPATH**/ ?>