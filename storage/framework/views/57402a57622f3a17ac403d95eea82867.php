...
<style>
    ...
    <section class="admin-visitor-area up_admin_visitor">
        <div class="container-fluid p-0">
                    ...
                    <div class="white-box filter_card">
                        ...
                        <div class="row row-gap-24">
                            ...
                            <?php else: ?>
                                ...
                                <?php if(canShowBoardFilter()): ?>
                                <div class="col-lg-4 col-md-6 global_board_filter_wrap">
                                    <div class="primary_input sm_mb_20">
                                        <label class="primary_input_label" for="student_list_board_id"><?php echo app('translator')->get('common.board'); ?></label>
                                        <select class="primary_select form-control" name="board_id" id="student_list_board_id">
                                            ...
                                            <?php $__currentLoopData = boardsForFilter(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $board): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($board); ?>"
                                                    <?php echo e((isset($board_id) ? $board_id : old('board_id')) === $board ? 'selected' : ''); ?>>
                                                    <?php echo e($board); ?>
                                ...
                                <?php else: ?>
                                    <input type="hidden" name="board_id" value="<?php echo e(selectedBoard()); ?>">
                                <?php endif; ?>
            ...
            <input type="hidden" id="board_id" value="<?php echo e(@$board_id); ?>">
...
<?php echo $__env->make('backEnd.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\infixEdu_v9.0.1\resources\views/backEnd/studentInformation/student_details.blade.php ENDPATH**/ ?>